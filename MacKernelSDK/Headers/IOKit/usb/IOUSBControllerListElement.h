...
public:
    ...
    virtual void					SetPhysicalLink(IOPhysicalAddress next) APPLE_KEXT_OVERRIDE = 0;
    virtual IOPhysicalAddress		GetPhysicalLink(void) APPLE_KEXT_OVERRIDE = 0;
    virtual IOPhysicalAddress		GetPhysicalAddrWithType(void) APPLE_KEXT_OVERRIDE = 0;
    virtual void					print(int level) APPLE_KEXT_OVERRIDE;
