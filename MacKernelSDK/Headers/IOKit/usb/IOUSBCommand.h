...
protected:
    virtual IOReturn gatedReturnCommand(IOCommand * command) APPLE_KEXT_OVERRIDE;
	virtual IOReturn gatedGetCommand(IOCommand ** command, bool blockForCommand) APPLE_KEXT_OVERRIDE;
