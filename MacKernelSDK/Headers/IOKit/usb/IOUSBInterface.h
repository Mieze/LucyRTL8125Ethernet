...
public:
    ...
    virtual bool		handleOpen(IOService *forClient, IOOptionBits options = 0, void *arg = 0 ) APPLE_KEXT_OVERRIDE;
    ...
    virtual void		handleClose(IOService *forClient, IOOptionBits options = 0) APPLE_KEXT_OVERRIDE;
    ...
    */
	LIBKERN_RETURNS_NOT_RETAINED virtual const IOUSBInterfaceDescriptor *FindNextAltInterface(const IOUSBInterfaceDescriptor *current,
    ...
    */
	LIBKERN_RETURNS_NOT_RETAINED virtual IOUSBPipe *FindNextPipe(IOUSBPipe *current, IOUSBFindEndpointRequest *request);
    ...
    */
	LIBKERN_RETURNS_NOT_RETAINED virtual const IOUSBDescriptorHeader * FindNextAssociatedDescriptor(const void *current, UInt8 type);
